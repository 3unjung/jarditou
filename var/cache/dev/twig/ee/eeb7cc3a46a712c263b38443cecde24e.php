...
class __TwigTemplate_dc67af7bf13655d31dea0e5b6f48dfed extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_users_index", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\">show</a>
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>{{ user.lastname }}</td>
                <td>
                    <a class=\"text-info\" href=\"{{ path('app_users_index', {'id': user.id}) }}\">show</a>
                    <a class=\"text-danger\" href=\"{{ path('app_users_edit', {'id': user.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "users/index.html.twig", "/home/quinella/Downloads/jarditou/templates/users/index.html.twig");
    }
}
